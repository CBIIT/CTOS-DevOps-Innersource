locals {
  ...
  ecs_backend_api_service_name = "${var.app}-ecs-service-backend-api-${terraform.workspace}"
  ...
  ecs_family_backend_api       = "${var.app}-ecs-family-backend-api-${terraform.workspace}"
