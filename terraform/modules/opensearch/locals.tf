locals {
  ...
  snapshot_role           = "${var.iam_prefix}-${var.app}-opensearch-snapshot-role-${var.tier}"
  snapshot_policy         = "${var.iam_prefix}-${var.app}-opensearch-snapshot-policy-${var.tier}"
  jenkins_snapshot        = "${var.iam_prefix}-${var.app}-jenkins-pass-role-os-snapshot-${var.tier}"
